...
import { ViewUsedCarListingController } from "@/controls/Controllers/UsedCarListingControllers/ViewUsedCarListingController";
...
class ViewUsedCarListingUI {
  ...
  public displayUsedCarListingUI = (): JSX.Element => {
    ...
    //   try {
    //     const users = await controller.viewUsedCarListingController();
